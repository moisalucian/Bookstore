package com.sda.lucianmoisa.bookstore.config;

import com.sda.lucianmoisa.bookstore.model.Role;
import com.sda.lucianmoisa.bookstore.service.UserService;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                ...
                .antMatchers("/createBook","/updateBook/*","/deleteBook/*", "/home-admin", "/create-admin").hasAuthority(Role.ADMIN.name()/*metoda care converteste enumul in string*/)
